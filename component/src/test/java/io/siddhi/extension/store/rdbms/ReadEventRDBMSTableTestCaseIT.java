...
public class ReadEventRDBMSTableTestCaseIT {
    private static final Logger log = LogManager.getLogger(ReadEventRDBMSTableTestCaseIT.class);
...
//                "@PrimaryKey(\"itemId\")\n" +
    ...
    public void readEventRDBMSTableTestCase11() throws InterruptedException {
        ...
        String streams2 = "" +
                ...
                "@Store(type=\"rdbms\", jdbc.url=\"" + url + "\", " +
                "username=\"" + user + "\", password=\"" + password + "\", jdbc.driver.name=\"" + driverClassName +
                "\", field.length=\"column1:100\", pool.properties=\"maximumPoolSize:1\", @Cache(size=\"2\"))\n" +
                "define table StockTable (column1 string, column4 float, column5 bool);\n";
    ...
    @Test(dependsOnMethods = "readEventRDBMSTableTestCase11")
    public void readEventRDBMSTableTestCase12() throws InterruptedException {

        log.info("readEventRDBMSTableTestCase12");
        SiddhiManager siddhiManager = new SiddhiManager();
        String streams = "" +
                "define stream FirstStream (column1 string, column2 string, column3 string, column4 float, " +
                "column5 bool, column6 double);\n" +
